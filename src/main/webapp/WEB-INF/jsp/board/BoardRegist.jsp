			...
			<table class="chart2">
				...
				<tbody>
					<tr>
						<th scope="row">제목</th>
						<td>
							<input type="text" id="boardSj" name="boardSj" title="제목입력" class="q3"
								value="<c:out value="${result.boardSj}"/>"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row">내용</th>
						<td>
							<textarea id="boardCn" name="boardCn" rows="15" title="내용입력"><c:out value="${result.boardCn}"/></textarea> <!-- textarea는 절대로 enter 치면 안된다. -->
						</td>
					</tr>
						...
						<tr>
							...
							<td>
								<c:import url="/cmm/fms/selectFileInfoForUpdate.do" charEncoding="utf-8">
									<c:param name="param_atchFileId" value="${result.atchFileId}"></c:param>
								</c:import>
							</td>
						</tr>
					</c:if>
...
<script src="https://cdn.tiny.cloud/1/vklvfvujxayyutys9u49j7pnek99tmuohbfkm7hb0gp9u44a/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
$(function(){
    var plugins = [
