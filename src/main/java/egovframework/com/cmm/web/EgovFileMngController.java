...
public class EgovFileMngController {
	...
	public String selectFileInfo(@ModelAttribute("searchVO") FileVO fileVO, HttpServletRequest request, 
			@RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception{
		String param_atchFileId = (String) commandMap.get("param_atchFileId");
		...
		model.addAttribute("fileList", result);
		model.addAttribute("updateFlag", result);
		model.addAttribute("fileListCnt", result.size());
		model.addAttribute("atchFileId", param_atchFileId);
	...
	public String selectFileInfoForUpdate(@ModelAttribute("searchVO") FileVO fileVO, 
