...
public class NaverLoginServiceImpl extends EgovAbstractServiceImpl implements NaverLoginService{
	...
	public String getAuthorizationUrl(HttpSession session, String domain, String port) {
		...
		String state = generateRanString();
		setSession(session,state);
		
		/*Scribe에서 제공하는 인증 URL 생성 기능을 이용하여 네이버 인증 URL생성*/
	...
	public OAuth2AccessToken getAccessToken(HttpSession session, String code, String state, String domain, String port)
		...
		if(StringUtils.pathEquals(sessionState,state)) {
			...
			/*Scribe에서 제공하는 AccessToken 획등 기능으로 Access Token 획득*/
	...
	public String generateRanString() {
